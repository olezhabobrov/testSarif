...
{
    struct StructWithPointerInField actual = some_calc(-7, 3);
...
{
    struct StructWithPointerInField actual = some_calc(2, 0);
    struct StructWithPointerInField expected = {
        .ll = 0LL,
        .sh = 0,
        .a = {
...
{
    struct StructWithPointerInField actual = some_calc(10, -3);
    struct StructWithPointerInField expected = {
        .ll = 33333LL,
        .sh = 33,
        .a = {
