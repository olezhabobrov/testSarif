...
{
    __attribute__ ((aligned(1))) struct Trio arr[10] = {{0, 8LL, 0}, {8, 8LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}};
    int actual = index_of_struct_with_equal_fields(arr);
    EXPECT_EQ(2, actual);
    struct Trio expected_arr[10] = {{0, 8LL, 0}, {8, 8LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}, {0, 0LL, 0}};
    for (int it_3_0 = 0; it_3_0 < 10; it_3_0 ++) {
        EXPECT_EQ(expected_arr[it_3_0].a, arr[it_3_0].a);
        EXPECT_EQ(expected_arr[it_3_0].b, arr[it_3_0].b);
        EXPECT_EQ(expected_arr[it_3_0].c, arr[it_3_0].c);
