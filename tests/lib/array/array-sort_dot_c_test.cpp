    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_115_0 = 0; it_115_0 < 10; it_115_0 ++) {
                klee_prefer_cex(sort_array_with_comparator_cmp_symbolic, sort_array_with_comparator_cmp_symbolic[it_115_0] >= -10  & sort_array_with_comparator_cmp_symbolic[it_115_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
