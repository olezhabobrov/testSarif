...
TEST(regression, use_global_array_test_2)
{
    ...
    for (int it_252_0 = 0; it_252_0 < 3; it_252_0 ++) {
        EXPECT_EQ(expected_global_array[it_252_0], global_array[it_252_0]);
    }
}
...
{
    char global_mutable_string_buffer[] = "ccacbccbb";
    global_mutable_string = global_mutable_string_buffer;
    char global_const_string_buffer[] = "{cbcccccc";
...
TEST(regression, use_global_strings_test_2)
{
    char global_mutable_string_buffer[] = "ccacbccbb";
    global_mutable_string = global_mutable_string_buffer;
    char global_const_string_buffer[] = "ccbcccccc";
    global_const_string = global_const_string_buffer;
    char actual = use_global_strings();
    EXPECT_EQ('C', actual);
