...
{
    int global_array_buffer[3] = {-8, -8, 0};
    memcpy((void *) global_array, global_array_buffer, sizeof(global_array_buffer));
    int actual = use_global_array(0);
    EXPECT_EQ(24, actual);
    int expected_global_array[3] = {-8, -8, 0};
    for (int it_247_0 = 0; it_247_0 < 3; it_247_0 ++) {
        EXPECT_EQ(expected_global_array[it_247_0], global_array[it_247_0]);
    }
}
...
TEST(regression, use_global_array_test_2)
{
    ...
    for (int it_248_0 = 0; it_248_0 < 3; it_248_0 ++) {
        EXPECT_EQ(expected_global_array[it_248_0], global_array[it_248_0]);
    }
}
...
TEST(regression, use_global_array_test_3)
{
    ...
    for (int it_249_0 = 0; it_249_0 < 3; it_249_0 ++) {
        EXPECT_EQ(expected_global_array[it_249_0], global_array[it_249_0]);
    }
}

TEST(regression, use_global_strings_test_1)
{
    char global_mutable_string_buffer[] = "ccabcbccc";
    global_mutable_string = global_mutable_string_buffer;
    char global_const_string_buffer[] = "{cbcaaccc";
...
TEST(regression, use_global_strings_test_2)
{
    char global_mutable_string_buffer[] = "ccabcbccc";
    global_mutable_string = global_mutable_string_buffer;
    char global_const_string_buffer[] = "ccbcaaccc";
    global_const_string = global_const_string_buffer;
    char actual = use_global_strings();
    EXPECT_EQ('C', actual);
