    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_1_0 = 0; it_1_0 < 10; it_1_0 ++) {
                klee_prefer_cex(_calc_two_numbers_symbolic, _calc_two_numbers_symbolic[it_1_0] >= -10  & _calc_two_numbers_symbolic[it_1_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_4_0 = 0; it_4_0 < 10; it_4_0 ++) {
                klee_prefer_cex(_calc_two_numbers_f_symbolic, _calc_two_numbers_f_symbolic[it_4_0] >= -10  & _calc_two_numbers_f_symbolic[it_4_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
