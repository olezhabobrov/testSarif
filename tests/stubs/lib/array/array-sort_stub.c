    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_5_0 = 0; it_5_0 < 10; it_5_0 ++) {
                klee_prefer_cex(_sort_array_symbolic, _sort_array_symbolic[it_5_0] >= -10  & _sort_array_symbolic[it_5_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_6_0 = 0; it_6_0 < 10; it_6_0 ++) {
                klee_prefer_cex(_sort_array_with_comparator_symbolic, _sort_array_with_comparator_symbolic[it_6_0] >= -10  & _sort_array_with_comparator_symbolic[it_6_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
