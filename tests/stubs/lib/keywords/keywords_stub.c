    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_102_0 = 0; it_102_0 < 10; it_102_0 ++) {
                klee_prefer_cex(_get_size_of_data_symbolic, _get_size_of_data_symbolic[it_102_0] >= -10  & _get_size_of_data_symbolic[it_102_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_103_0 = 0; it_103_0 < 10; it_103_0 ++) {
                // No constraints for _get_flag_symbolic[it_103_0]
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_104_0 = 0; it_104_0 < 10; it_104_0 ++) {
                // No constraints for _equals_symbolic[it_104_0]
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_105_0 = 0; it_105_0 < 10; it_105_0 ++) {
                klee_prefer_cex(_access_to_int_symbolic, _access_to_int_symbolic[it_105_0] >= -10  & _access_to_int_symbolic[it_105_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
