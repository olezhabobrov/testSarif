    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_73_0 = 0; it_73_0 < 10; it_73_0 ++) {
                klee_prefer_cex(_c_strcmp_2_symbolic, _c_strcmp_2_symbolic[it_73_0] >= -10  & _c_strcmp_2_symbolic[it_73_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_74_0 = 0; it_74_0 < 10; it_74_0 ++) {
                klee_prefer_cex(_ishello_2_symbolic, _ishello_2_symbolic[it_74_0] >= -10  & _ishello_2_symbolic[it_74_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
