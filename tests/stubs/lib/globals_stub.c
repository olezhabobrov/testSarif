    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_58_0 = 0; it_58_0 < 10; it_58_0 ++) {
                klee_prefer_cex(_increment_symbolic, _increment_symbolic[it_58_0] >= -10  & _increment_symbolic[it_58_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_59_0 = 0; it_59_0 < 10; it_59_0 ++) {
                klee_prefer_cex(_use_global_array_symbolic, _use_global_array_symbolic[it_59_0] >= -10  & _use_global_array_symbolic[it_59_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_60_0 = 0; it_60_0 < 10; it_60_0 ++) {
                klee_prefer_cex(_use_global_strings_symbolic, _use_global_strings_symbolic[it_60_0] >= 'a' & _use_global_strings_symbolic[it_60_0] <= 'z' & _use_global_strings_symbolic[it_60_0] != '\0');
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_61_0 = 0; it_61_0 < 10; it_61_0 ++) {
                klee_prefer_cex(_use_global_arrays_symbolic, _use_global_arrays_symbolic[it_61_0] >= -10  & _use_global_arrays_symbolic[it_61_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
