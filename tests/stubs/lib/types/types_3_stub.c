    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_106_0 = 0; it_106_0 < 10; it_106_0 ++) {
                klee_prefer_cex(_extract_value_symbolic, _extract_value_symbolic[it_106_0] >= -10  & _extract_value_symbolic[it_106_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_107_0 = 0; it_107_0 < 10; it_107_0 ++) {
                klee_prefer_cex(_extract_value_2_symbolic, _extract_value_2_symbolic[it_107_0] >= -10  & _extract_value_2_symbolic[it_107_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_108_0 = 0; it_108_0 < 10; it_108_0 ++) {
                klee_prefer_cex(_extract_value_3_symbolic, _extract_value_3_symbolic[it_108_0] >= -10  & _extract_value_3_symbolic[it_108_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_109_0 = 0; it_109_0 < 10; it_109_0 ++) {
                klee_prefer_cex(_extract_value_4_symbolic, _extract_value_4_symbolic[it_109_0] >= -10  & _extract_value_4_symbolic[it_109_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_110_0 = 0; it_110_0 < 10; it_110_0 ++) {
                klee_prefer_cex(_sum_of_symbolic, _sum_of_symbolic[it_110_0] >= -10  & _sum_of_symbolic[it_110_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_111_0 = 0; it_111_0 < 10; it_111_0 ++) {
                klee_prefer_cex(_mul_of_symbolic, _mul_of_symbolic[it_111_0] >= -10  & _mul_of_symbolic[it_111_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_112_0 = 0; it_112_0 < 10; it_112_0 ++) {
                // No constraints for _check_option_symbolic[it_112_0]
            }
        }
    #endif
    if (cntCall == 10) {
