    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_89_0 = 0; it_89_0 < 10; it_89_0 ++) {
                klee_prefer_cex(_enumSign1ToInt_symbolic, _enumSign1ToInt_symbolic[it_89_0] >= -10  & _enumSign1ToInt_symbolic[it_89_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_90_0 = 0; it_90_0 < 10; it_90_0 ++) {
                // No constraints for _intToSign1_symbolic[it_90_0]
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_91_0 = 0; it_91_0 < 10; it_91_0 ++) {
                klee_prefer_cex(_enumSign2ToInt_symbolic, _enumSign2ToInt_symbolic[it_91_0] >= -10  & _enumSign2ToInt_symbolic[it_91_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_92_0 = 0; it_92_0 < 10; it_92_0 ++) {
                // No constraints for _intToSign2_symbolic[it_92_0]
            }
        }
    #endif
    if (cntCall == 10) {
